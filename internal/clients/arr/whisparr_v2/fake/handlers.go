...
// Whisparr v2 maps numeric eventType filters to string event names, matching
// Sonarr. The real client uses eventType=3 → "downloadFolderImported".
...
func (s *Server) handleEpisodeFiles(w http.ResponseWriter, r *http.Request) {
	...
	if files == nil {
		// Match Sonarr: unknown seriesId yields [] rather than 404.
...
func (s *Server) handleDeleteEpisodeFile(w http.ResponseWriter, r *http.Request) {
	...
	s.logger.Info("fake-whisparr_v2: delete episodefile",
...
func (s *Server) handleUnknown(w http.ResponseWriter, r *http.Request) {
	s.logger.Warn("fake-whisparr_v2: unimplemented endpoint",
